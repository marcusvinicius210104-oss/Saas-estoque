...
2. Configure o `.env` (um `.env` já é criado a partir do `.env.example` na
   primeira execução do Prisma; ajuste os valores):
...
6. Acesse [http://localhost:3000](http://localhost:3000) e entre com as
